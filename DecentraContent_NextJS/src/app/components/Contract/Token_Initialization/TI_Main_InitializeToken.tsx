...
const handleContractCall = async () => {
  ...
  try {
    ...
    const tokenIdFromEvent = result.events.TokenAssigned.returnValues as TokenAssignedReturnValues;
    ...
    <div className="flex flex-col justify-center items-center space-y-6 mt-6">
      ...
      <div className="flex flex-row justify-center items-center space-x-6">
        ...
        <div className="flex flex-col justify-center items-left bg-pink-600 space-y-6 p-4 border-2 rounded-lg">
          ...
          <Get_TokenInfo_Button handleGetTokenInfo={handleGetTokenInfo} tokenId={tokenData.tokenId} />
          {showTokenInfo && tokenData.tokenId && <GetTokenInfo tokenId={tokenData.tokenId} />}
        </div>
      </div>
    </div>
  );
